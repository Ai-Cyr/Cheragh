...
TECHNIQUES: tuple[TechniqueSpec, ...] = (
    ...
    _spec("propositional", "Propositional retrieval", TechniqueFamily.INDEXING, TechniqueStatus.EXPERIMENTAL, "cheragh.PropositionalRetriever", "Index generated atomic propositions while returning source context."),
    _spec("bm25", "BM25", TechniqueFamily.RETRIEVAL, TechniqueStatus.STABLE, "cheragh.HybridSearchRetriever", "Sparse lexical first-stage retrieval."),
    ...
    _spec("rrf", "Reciprocal Rank Fusion", TechniqueFamily.RETRIEVAL, TechniqueStatus.BETA, "cheragh.ReciprocalRankFusionReranker", "Rank-based result fusion."),
    ...
    _spec(
        ...
        limitations=("Exact in-memory MaxSim; no compressed ANN index is bundled.",),
    ),
    ...
    _spec("self-query", "Self-query retrieval", TechniqueFamily.QUERY, TechniqueStatus.EXPERIMENTAL, "cheragh.SelfQueryRetriever", "Generate a semantic query plus metadata filters."),
    ...
    _spec("context-compression", "Contextual compression", TechniqueFamily.AUGMENTATION, TechniqueStatus.BETA, "cheragh.CompressionPipeline", "Remove irrelevant and redundant retrieved text."),
    ...
    _spec("conversational", "Conversational RAG", TechniqueFamily.ORCHESTRATION, TechniqueStatus.BETA, "cheragh.ConversationalRAGEngine", "Retrieve with bounded conversation memory."),
    ...
    _spec("community-graphrag", "Community GraphRAG", TechniqueFamily.ORCHESTRATION, TechniqueStatus.PLANNED, None, "Community detection, community reports and global/local search."),
    _spec("colpali", "Visual-document late interaction", TechniqueFamily.MULTIMODAL, TechniqueStatus.PLANNED, None, "Page-image multi-vector retrieval with a ColPali-compatible adapter."),
    _spec("temporal-rag", "Temporal RAG", TechniqueFamily.RETRIEVAL, TechniqueStatus.PLANNED, None, "Freshness-aware retrieval and temporal conflict resolution."),
    _spec("retrieval-training", "Retriever/RAG training", TechniqueFamily.EVALUATION, TechniqueStatus.PLANNED, None, "Negative mining, distillation and retrieval-aware fine-tuning adapters."),
)
